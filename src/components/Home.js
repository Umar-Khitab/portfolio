      ...
      <div className="devman_tm_hero">
        ...
        <div className="container">
          <div className="content">
            ...
            <div className="right">
              <div className="image">
                <Image src="/img/thumbs/53-61.jpg" alt="thumbs" layout="fill" />
                <div className="main" data-img-url={homeData.img} />
                <span className="win">
                  <Image src="/img/svg/award.svg" alt="awart photo" className="svg" layout="fill" />
                </span>
                ...
                <span className="circle anim_circle">
                  <Image src="/img/hero/circle.png" alt="hero photo" layout="fill" />
                </span>
              </div>
            </div>
          </div>
