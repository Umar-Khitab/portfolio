          ...
          <div className="about_inner">
            <div className="left">
              <div className="image_wrap">
                <Image src="/img/thumbs/64-49.jpg" alt="thumbs photo" layout='fill'/>
                <div className="main" data-img-url="img/about/1.jpg" />
                <div className="extra_image">
                  <div className="image_inner">
                    <Image src="/img/thumbs/1-1.jpg" alt="thumbs photo" layout='fill' />
                    <div
                ...
                {aboutData.skillIcons.map((skill, i) => (
                  <div className={i === 0 ? "extra_image" : ""} key={i}>
                    ...
                    >
                      <Image className="svg" src={skill.icon} alt="joomla images" layout='fill'/>
                    </span>
                  </div>
                ))}
              </div>
